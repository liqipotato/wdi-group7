...
public class HqcityEvaluationRule extends EvaluationRule<Company, Attribute> {
	@Override
	public boolean isEqual(Company record1, Company record2, Attribute schemaElement) {
		if(record1.getHqcity()== null && record2.getHqcity()==null)
			return true;
		else if(record1.getHqcity()== null ^ record2.getHqcity()==null)
			return false;
		else 
			return record1.getHqcity().equals(record2.getHqcity());
	}
