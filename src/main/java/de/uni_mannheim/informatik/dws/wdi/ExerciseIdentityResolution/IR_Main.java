...
public class IR_Main {
	...
	public static void main(String[] args) throws Exception {
		...
		// StandardRecordBlocker<Company, Attribute> blocker = new StandardRecordBlocker<Company, Attribute>(new CompanyBlockingKeyByIndustryGenerator());
		// NoBlocker<Company, Attribute> blocker = new NoBlocker<>();
		SortedNeighbourhoodBlocker<Company, Attribute, Attribute> blocker = new SortedNeighbourhoodBlocker<>(new CompanyBlockingKeyByIndustryGenerator(), 30);
